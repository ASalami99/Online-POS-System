    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(IT_admin.jLabel6.getWidth(), IT_admin.jLabel6.getHeight(), Image.SCALE_DEFAULT));
                IT_admin.jLabel6.setIcon(imageico);
            }
        } catch (Exception e) {
