...
public class Webcam2 extends javax.swing.JFrame {
    ...
    private Webcam2.DaemonThread myThread = null;
    ...
    public Webcam2() {
        ...
        myThread = new Webcam2.DaemonThread(jLabel1);
    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(IT_admin.jLabel7.getWidth(), IT_admin.jLabel7.getHeight(), Image.SCALE_DEFAULT));
                IT_admin.jLabel7.setIcon(imageico);
            }
        } catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == 0) {
            try {
                ...
                Filename = file.getAbsolutePath() + "\\" + "Webcam2" + imageNo + ".jpg";
                ...
                IT_admin.jTextField7.setText(Filename);
                ...
                IT_admin.photo = baos.toByteArray();
                dispose();
            } catch (Exception e) {
                stopCam();
                JOptionPane.showMessageDialog(rootPane, "Warning");
